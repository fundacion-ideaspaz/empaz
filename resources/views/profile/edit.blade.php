            ...
            <form action="/profile/empresa/{{Auth::user()->id}}" method="POST" class="form">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="sector_economico">
                        ...
                        <option value="4620">   4620 - Comercio al por menor de carnes, productos cárnicos, pescados y productos de mar, en establecimientos especializados</option>
                        ...
                        <option value="8530">   8530 - Establecimientos que combinan diferentes niveles de educación inicial, preescolar, básica primaria, básica secundaria y media</option>
                        ...
                        <option value="4761">   4761 - Comercio al por menor de libros, periódicos, materiales y artículos de papelería y escritorio, </option>
                        ...
                        <option value="8020">   8020 - Actividades de servicios de sistemas de seguridad, reparación de sistemas de seguridad.  </option>
                        ...
                        <option value="6201">   6201 - Actividades de desarrollo de sistemas informática (Planificación, análisis, diseño, programación, pruebas)</option>
                        <option value="6202">   6202 - Actividades de consultoría informática y actividades de administración de instalaciones informática</option>
