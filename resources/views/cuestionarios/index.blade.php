          ...
          <tr class="parent">
            ...
            <td width="25%">
              ...
              <a class="btn btn-sm btn-danger" href="/cuestionarios/{{$cuestionario->id}}/delete" data-toggle="tooltip" data-placement="bottom" title="Eliminar"><i class="fa fa-trash" aria-hidden="true"></i></a>
                  <a class="btn btn-sm btn-primary descripcion tip" data-placement="bottom" href="#" data-toggle="tooltip"><i class="fa fa-info-circle" aria-hidden="true"></i> <span>{!!$cuestionario->descripcion!!}</span></a>
            </td>
            </tr>
