<li data-input-trigger id="r-{{$pregunta->id}}">
  ...
  <a class="btn btn-sm btn-primary descripcion" data-placement="bottom" href="#" data-toggle="tooltip" title="<div class'tool'>{{$pregunta->descripcion}}</div>"><i class="fa fa-info-circle" aria-hidden="true"></i></a>
