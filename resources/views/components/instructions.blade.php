<li data-input-trigger>
      <div class="instructions-box">
        ...
        <label class="fs-anim-upper instructions">
          <p>En cada pregunta, usted encontrará descripciones de términos y conceptos con su explicación, presionando el botón i (también puede consultar la sección Glosario de EmPaz). </p>
          <p>Para cada pregunta del cuestionario, usted podrá escoger entre tres a cinco opciones de respuesta, la que más se ajuste a la situación de su empresa.</p>
          <p>Si no hay o no tiene acceso a los datos necesarios para responder, usted podrá escoger la opción “No hay información”. Tenga en cuenta que esta respuesta se valora con la calificación mínima de 1 punto.</p>
          <p>Presionando el botón Continuar, usted accederá a la siguiente pregunta.</p>
